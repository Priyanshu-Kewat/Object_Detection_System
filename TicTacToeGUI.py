...
frame1 = Frame(root)
frame1.pack()
titleLabel = Label(frame1, text="Tic Tac Toe", font=("Arial", 26), bg="lightblue", width=16)
...
def changeModeToSinglePlayer():
    global mode
    mode = "singlePlayer"
    singlePlayerButton["bg"] = "lightpink"
...
def restartGame():
    ...
    titleLabel = Label(frame1, text="Tic Tac Toe", font=("Arial", 30), bg="lightblue", width=15)
    titleLabel.grid(row=0, column=0)
    ...
    if button["text"] == " ":
        if turn == "x":
            ...
            if mode == "singlePlayer":
                ...
                if checkForWin(turn):
                    winningLabel = Label(frame1, text=f"{turn} wins the game", bg="red", font=("Arial", 26),
                                         width=16)
                    winningLabel.grid(row=0, column=0, columnspan=3)
                    game_end = True
        ...
        if checkForDraw():
            drawLabel = Label(frame1, text=f"Game Draw", bg="lightblue", font=("Arial", 26), width=16)
            drawLabel.grid(row=0, column=0, columnspan=3)

singlePlayerButton = Button(optionFrame, text="SinglePlayer", width=13, height=1, font=("Arial", 15), bg="lightblue",
...
multiPlayerButton = Button(optionFrame, text="Multiplayer", width=13, height=1, font=("Arial", 15), bg="lightblue",
...
options_menu.add_command(label="Reset Game", command=restartGame)
root.mainloop()
